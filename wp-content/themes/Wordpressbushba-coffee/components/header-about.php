        <header class="header-page">
            <div class="nav-wrapper" style="<?php echo is_user_logged_in() ? 'top: 30px;' : '' ?>">
                <nav class="navbar">
            ...
            <div class="main-text">
                <p class="company-name">BUSBHA COFFEE</p>
                <h1 class="main-title">BUSHBA MICRO <br> COFFEE ROASTERS</h1>
                <p class="description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis minima voluptatem dolores laborum labore nesciunt corrupti, autem rerum eius laboriosam.</p>
            </div>
        </header>