...
<?php foreach ( $cart['items'] as $item ) { ?>
	<div class="bc-cart-item product" data-js="<?php echo esc_attr( $item['id'] ); ?>">
		...
		<div class="bc-cart-item-meta info">
		...
		<div class="<?php echo esc_attr( $price_classes ); ?> ">
		 <p class="price">
			...
			<button class="minus-btn" data-js="bc-cart-item__quantity" data-cart_item_id="<?php echo esc_attr( $item['id'] ); ?>" data-action="dec">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M12.5 2C17.7471 2 22 6.25395 22 11.5C22 16.7461 17.7471 21 12.5 21C7.25395 21 3 16.7461 3 11.5C3 6.25395 7.25395 2 12.5 2Z" stroke="#262C35" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"/>
                        <path class="line" d="M15 11.5H10" stroke="#262C35" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
				...
				<input
						...
						class="bc-cart-item__quantity-input count-elm"
						data-js="bc-cart-item__quantity" data-cart_item_id="<?php echo esc_attr( $item['id'] ); ?>"
						value="<?php echo intval( $item['quantity'] ); ?>"
						min="<?php echo esc_attr( $min ); ?>"
						max="<?php echo esc_attr( $max ); ?>"
				>
				 <button class="plus-btn" data-js="bc-cart-item__quantity" data-cart_item_id="<?php echo esc_attr( $item['id'] ); ?>" data-action="inc">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M12.5 2C17.7471 2 22 6.25395 22 11.5C22 16.7461 17.7471 21 12.5 21C7.25395 21 3 16.7461 3 11.5C3 6.25395 7.25395 2 12.5 2Z" stroke="#262C35" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"/>
                        <path class="line" d="M15 11.5H10" stroke="#262C35" stroke-linecap="round" stroke-linejoin="round"/>
                        <path class="line" d="M12.5 14V9" stroke="#262C35" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
				    ...
				    <button class="delete-btn bc-link bc-cart-item__remove-button"
					data-js="remove-cart-item"
					data-cart_item_id="<?php echo esc_attr( $item['id'] ); ?>"	type="button">
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                    ...
                    >
                      <path
                        d="M18.0025 6.00211L6.0025 18.0021"
                        stroke="#200E32"
                        stroke-width="1.5"
